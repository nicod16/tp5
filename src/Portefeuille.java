public class Portefeuille {
   ...
   */
	...
	{
		if (this.monnaie.equals(destination.getMonnaie()) && this.montant >= montantJetons && montantJetons >= 0)
		{
   ...
   */
	public boolean achatDevise(double montantEuros)
	{
		if (montantEuros >= 0)
		{
			double nouveauxJetons = montantEuros / this.monnaie.getValeurDeJeton();
			this.montant += nouveauxJetons;
			return true;
		}
